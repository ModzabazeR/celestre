...
const th: localeObj = {
    ...
    sortByDuration: 'เรียงตามความยาว',
    descending: 'มากไปน้อย',
    ascending: 'น้อยไปมาก',
    disclaimer: 'Celestre ไม่มีความเกี่ยวข้องใดๆ กับ HoYoverse\nเนื้อหาในเกม Genshin Impact และวัสดุทุกอย่างถือเป็นลิขสิทธิ์ของ HoYoverse แต่เพียงผู้เดียว',
